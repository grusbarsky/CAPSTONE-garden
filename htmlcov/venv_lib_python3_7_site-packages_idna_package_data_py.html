...
<head>
    ...
    <title>Coverage for venv/lib/python3.7/site-packages/idna/package_data.py: 100%</title>
...
<div id="header">
    <div class="content">
        <h1>Coverage for <b>venv/lib/python3.7/site-packages/idna/package_data.py</b> :
...
<div id="source">
    <p id="t1" class="run"><span class="n"><a href="#t1">1</a></span><span class="t"><span class="nam">__version__</span> <span class="op">=</span> <span class="str">'3.2'</span>&nbsp;</span><span class="r"></span></p>
